...
public class ObjectFactory {
    ...
    private final static QName _GetEntryStateless_QNAME = new QName("http://stateless_SOAP_webservice/", "getEntryStateless");
    private final static QName _GetEntryStatelessResponse_QNAME = new QName("http://stateless_SOAP_webservice/", "getEntryStatelessResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://stateless_SOAP_webservice/", name = "getEntryStateless")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://stateless_SOAP_webservice/", name = "getEntryStatelessResponse")
